...
function dp_tiny_mce_editor_inline_css($settings){
	...
	$selector = array(
		...
		'div.editor-styles-wrapper',	// Classic editor block in Gutenberg
...
$selector." blockquote::after{
	color:".$options_visual['accent_color'].";
}".
$selector." table th,".
$selector." table td,".
$selector." dl,".
$selector." dt,".
$selector." dd{
	border-color:rgba(".$rgb_base_font_color[0].",".$rgb_base_font_color[1].",".$rgb_base_font_color[2].",.18)!important;
}".
$selector." dt,".
$selector." table th{
	background-color:rgba(".$rgb_base_font_color[0].",".$rgb_base_font_color[1].",".$rgb_base_font_color[2].",.04);
...
$selector." .btn:not([class*=btn-]):hover::after{
...
$selector." pre:not(.CodeMirror-line){
	color:".$options_visual['container_bg_color'].";
	background-color:".$options_visual['accent_color'].";
}";
	}
