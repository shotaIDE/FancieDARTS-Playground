...
// **********************************
?>
<div id="container" class="dp-container content clearfix<?php echo $cur_page_class.$has_header_class.$float_css; ?>">
<?php
// **********************************
...
<div class="widget-container top mobile clearfix<?php echo $cur_page_class; ?>">
