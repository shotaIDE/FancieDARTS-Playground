...
<li class="menu-item"><a href="<?php echo home_url(); ?>" title="HOME" class="icon-home menu-link"><?php _e('HOME','DigiPress'); ?></a></li>
<li class="menu-item"><a href="<?php echo get_feed_link(); ?>" target="_blank" title="feed" class="icon-rss menu-link">RSS</a></li>
</ul>
<?php
} //End Function
