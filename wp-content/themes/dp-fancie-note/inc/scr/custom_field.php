...
_EOD_;
	...
	echo '<div class="dp_cf_item_box"><p class="b">'.__('Archive slider images:','DigiPress').'</p>
		 ...
		 <div class="mg10px-btm">'.__('Image ','DigiPress').'1 : <input type="text" name="dp_archive_slider_img1" id="dp_archive_slider_img1" class="img_url" size="50" style="width:70%;" value="'.$dp_archive_slider_img1.'" /><input class="dp_upload_image_button button" type="button" value="'.__('Add / Change','DigiPress').'" /></div>
		 <div class="mg10px-btm">'.__('Image ','DigiPress').'2 : <input type="text" name="dp_archive_slider_img2" id="dp_archive_slider_img2" class="img_url" size="50" style="width:70%;" value="'.$dp_archive_slider_img2.'" /><input class="dp_upload_image_button button" type="button" value="'.__('Add / Change','DigiPress').'" /></div>
		 <div class="mg10px-btm">'.__('Image ','DigiPress').'3 : <input type="text" name="dp_archive_slider_img3" id="dp_archive_slider_img3" class="img_url" size="50" style="width:70%;" value="'.$dp_archive_slider_img3.'" /><input class="dp_upload_image_button button" type="button" value="'.__('Add / Change','DigiPress').'" /></div>';
	echo '</div>';
	...
	echo '<div class="dp_cf_item_box">
		<p class="b">'.__('Header Slider Image URL(Optional):','DigiPress').'</p><p>'.__('Enter the URL to your slideshow image below, if you want to customize default image of slideshow.', 'DigiPress').'</p>
		 ...
		 <input id="upload_image_button" class="dp_upload_image_button button" type="button" value="'.__('Add / Change','DigiPress').'" /><br />* '
