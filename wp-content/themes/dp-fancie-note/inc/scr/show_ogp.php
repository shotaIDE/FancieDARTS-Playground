...
function dp_show_ogp() {
	...
	if (is_single() || is_page()) {
		...
		$img_url = show_post_thumbnail($arg);
	...
	// OGP tag
	$ogp_code = 
'<meta property="og:title" content="' . $title . '" /><meta property="og:type" content="' . $type . '" /><meta property="og:url" content="' . $url .'" /><meta property="og:image" content="' . $img_url . '" /><meta property="og:description" content="' . $desc . '" /><meta property="og:site_name" content="' . $site_name . '" />'.$fb_app_id;
