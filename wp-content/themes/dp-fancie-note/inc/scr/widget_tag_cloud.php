...
****************************************************************/
function dp_override_widget_tag_cloud() {
	class DP_Widget_Tag_cloud extends WP_Widget_Tag_Cloud {
		/**
		...
		public function widget( $args, $instance ) {
			...
			$number = !empty($instance['number']) ? (int)$instance['number'] : 45;
		...
		public function update( $new_instance, $old_instance ) {
			...
			$instance['number'] = !empty($new_instance['number']) ? $new_instance['number'] : 45;
		...
		public function form( $instance ) {
			...
			$instance['number'] = !empty( $instance['number'] ) ? esc_attr( $instance['number'] ) : 45;
			...
			default:
				...
				// Number
				printf(
					'<p><label for="%1$s">%2$s</label> <input type="number" id="%1$s" name="%3$s" value="%4$s" min=0 style="width:60px;" /></p>',
					$number_id,
					__( 'Number:','DigiPress' ),
					$number_name,
					$instance['number']
	...
	register_widget( 'DP_Widget_Tag_cloud' );
}
add_action( 'widgets_init', 'dp_override_widget_tag_cloud' );