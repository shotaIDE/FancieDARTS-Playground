...
if (!empty($next_page_link)) :
	// 1st page
	if ( !is_paged() || (bool)$options['autopager'.$suffix_mb] ) :
...
<?php 
	...
	if (!empty($prev_page_link)) :
		if (!(bool)$options['autopager'.$suffix_mb]) :
			if ((function_exists('wp_pagenavi'))) : 
?>
<nav class="navigation clearfix"><?php wp_pagenavi(); ?></nav>
<?php 
...
?>
<nav class="navigation clearfix"><div class="navialignleft"><?php previous_posts_link(__('<span class="nav-arrow r-wrap"><i class="icon-left-open"></i></span>', '')) ?></div></nav>
<?php 
				endif; 	// end of $options['pagenation']
			endif;	// end of function_exists('wp_pagenavi')
